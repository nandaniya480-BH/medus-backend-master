...
<tr>
    <td align="left" bgcolor="#ffffff"
        ...
        <h3
            ...
            Neue Anfrage von einem Arbeitgeber</h3>
        <p
            ...
            <p
                style="font-size:13px;font-family:'Helvetica Neue',Arial,sans-serif;line-height:1.5em;color:#000000;margin:1em 0">
                Ein Unternehmen hat Interesse an Ihrem Lebenslauf gezeigt und möchte Sie zu einer
                offenen Stellenausschreibung kontaktieren. Klicken Sie auf den Link, um die Jobdetails zu sehen.</p>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" height="33"
                                ...
                                valign="middle">
                                <a href="{{ env('ENVIRONMENT_URL') }}/job/{{ $job->slug }}"
