                    ...
                    @foreach($jobs as $element)
                        <tr>
                            <td align="right"
                                ...
                                valign="left">
                                <a href="https://www.medus.work/Jobs/{{ $element->id }}"
                            ...
                            <td style="width: 25%">
                                <span
                                    style="font-size:12px;font-family:'Helvetica Neue',Arial,sans-serif;line-height:1.5em;color:#0097a7;margin:1em 0">
                                    {{ $element->Job_Suggestions->where('employeeID',$user->userID)->first()->recommandedValue }}%
                                </span> <br>
                                <span
