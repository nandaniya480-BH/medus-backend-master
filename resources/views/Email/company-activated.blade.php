...
<tr>
    <td align="left" bgcolor="#ffffff"
        ...
        <h3
            ...
            Lieber Kunde {{ $employer->name }}</h3>

        <p
            style="font-size:13px;font-family:'Helvetica Neue',Arial,sans-serif;line-height:1.5em;color:#000000;margin:1em 0">
            Es freut uns sehr Ihnen mitzuteilen, dass Ihr Account erfolgreich verifiziert und freigeschaltet wurde. Sie
            können nun Ihr Stellen-Inserat schnell und einfach auf medus.work erfassen.</p>
                    ...
                    <tr>
                        <td align="center" height="33"
                            ...
                            <a href="{{ env('ENVIRONMENT_URL') }}/login"
                                ...
                                target="_blank">Stellen-Inserat erfassen</a>
                        </td>
                    </tr>
                </tbody>
            </table>
